      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-8 py-4 border-2 border-aurea-orange text-aurea-orange font-bold font-body rounded-full hover:bg-aurea-orange hover:text-white transition-colors duration-300 w-full md:w-auto"
          >
            DOWNLOAD DO EDITAL
          </a>
        </div>
